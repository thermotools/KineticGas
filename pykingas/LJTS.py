...
Purpose: Wrapper for the LJTS class.
'''
...
from .libpykingas import cpp_LJTS
from pykingas.py_KineticGas import py_KineticGas

class LJTS(py_KineticGas):
    def __init__(self, sig, eps_div_k, mole_weights, is_ideal = True):
        ...
        self.cpp_kingas = cpp_LJTS(self.mole_weights, self.sigma, self.epsilon,self.is_idealgas,self._is_singlecomp)